        ...
        <div className="grid grid-cols-1 gap-7 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-base text-primary/80 sm:text-[17px] lg:text-lg">
              ...
              Companies (JSC - &quot;Aksiyadorlik Jamiyati&quot;) and Limited
              Liability Companies (LLC - &quot;Mas&apos;uliyati Cheklangan
              Jamiyat&quot;).
            </p>
            <p className="text-base text-primary/80 sm:text-[17px] lg:text-lg">
            ...
            <p className="text-base text-primary/80 sm:text-[17px] lg:text-lg">
              ...
              flexible rules on corporate governance, raising capital and other
              matters. A joint-stock company (JSC) is generally recommended as a
              legal form only in cases where you are planning a public offering
