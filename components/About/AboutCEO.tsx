    ...
    <div className="my-20 grid gap-10 lg:grid-cols-3">
      ...
      <div className="flex flex-col justify-center lg:col-span-2">
        ...
        <h3
          ...
          className="mx-4 text-xl font-bold tracking-wide text-secondary sm:text-2xl sm:leading-9 md:mx-0"
        >
          Oisha Rakhimova
        </h3>
        <p
          title="Almuda CEO"
          className="text-muted  mx-4 text-left text-[17px] leading-6 tracking-wide sm:text-lg sm:leading-8 md:mx-0"
        >
          Almuda CEO
        </p>
      </div>
